...
/**
 * Creating Referral Details Entity
 * @author Parag
 * @author Shivansh
 * @author Harshita
 * @author Shweta
...
public class ReferralDetails implements Serializable
{
    ...
    private Set<CandidateDetails> candidate;
    ...
    public void setCandidate( Set<CandidateDetails> candidate )
    {
        this.candidate = candidate;
    }


    public Set<CandidateDetails> getCandidate()
    {
        return candidate;
    }
    ...
    {
        return "ReferralDetails [referralId=" + referralId + ", employeeId=" + employeeId + ", emplpoyeeEmailAddress="
            + emplpoyeeEmailAddress + ", candidate=" + candidate + ", referralDetialsStatus=" + referralDetialsStatus
            + ", createdOn=" + createdOn + ", modifiedOn=" + modifiedOn + ", createdBy=" + createdBy + ", modifiedBy="
            + modifiedBy + "]";
    }
