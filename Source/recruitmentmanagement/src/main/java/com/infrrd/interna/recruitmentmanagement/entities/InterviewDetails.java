...
/**
 * Creating Interview Details Entity
 * @author Parag
 * @author Shivansh
 * @author Harshita
 * @author Shweta
...
public class InterviewDetails implements Serializable
{
    ...
    {
        return "InterviewDetails [interviewId=" + interviewId + ", candidateId=" + candidate + ", employeeId=" + employeeId
            + ", comments=" + comments + ", roundNumber=" + roundNumber + ", result=" + result + ", interviewTime="
            + interviewTime + ", createdOn=" + createdOn + ", createdBy=" + createdBy + ", modifiedOn=" + modifiedOn
            + ", modifiedBy=" + modifiedBy + ", interviewStatus=" + interviewStatus + "]";
    }
