...
public class DomainMasterDetails implements Serializable
{
    ...
    {
        return "DomainMasterDetails [domainMasterId=" + domainMasterId + ", domainName=" + domainName + ", domainStatus="
            + domainStatus + ", createdOn=" + createdOn + ", modifiedOn=" + modifiedOn + ", createdBy=" + createdBy
