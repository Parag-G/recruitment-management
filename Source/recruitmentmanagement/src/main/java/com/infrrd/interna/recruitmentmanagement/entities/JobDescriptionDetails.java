...
public class JobDescriptionDetails implements Serializable
{
    ...
    public String toString()
    {
        return "JobDescriptionDetails [jobDescriptionId=" + jobDescriptionId + ", domainMaster=" + domainMaster
            + ", jobPosition=" + jobPosition + ", experience=" + experience + ", vacancies=" + vacancies + ", jobTypeMaster="
            + jobTypeMaster + ", jobDescriptionStatus=" + jobDescriptionStatus + ", createdOn=" + createdOn + ", createdBy="
