...
/**
 * Creating JdRequiredSkill Entity
 * @author Parag
 * @author Shivansh
 * @author Harshita
 * @author Shweta
...
public class JdRequiredSkillDetails implements Serializable
{
    ...
    private Set<JobDescriptionDetails> jobDescription;
    ...
    public void setJobDescription( Set<JobDescriptionDetails> jobDescription )
    {
        this.jobDescription = jobDescription;
    }


    public Set<JobDescriptionDetails> getJobDescription()
    {
    ...
    {
        return "JdRequiredSkillDetails [jdRequiredSkillId=" + jdRequiredSkillId + ", skillId=" + skillId + ", skillName="
            + skillName + ", jdRequiredSkillStatus=" + jdRequiredSkillStatus + ", createdOn=" + createdOn + ", modifiedOn="
            + modifiedOn + ", createdBy=" + createdBy + ", modifiedBy=" + modifiedBy + ", jobDescription=" + jobDescription
            + "]";
    }
