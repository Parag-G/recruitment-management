...
public class InterviewerDetails implements Serializable
{
    ...
    {
        return "Interviewer [interviewerId=" + interviewerId + ", employeeId=" + employeeId + ", employee_email_address="
            + employee_email_address + ", skillId=" + skillId + ", skillName=" + skillName + ", round_level=" + round_level
            + ", interviewerStatus=" + interviewerStatus + ", createdOn=" + createdOn + ", modifiedOn=" + modifiedOn
