	...
	*/
	...
	public String toString() {
		return "SelectedCandidateDetails [selectedCandidateId=" + selectedCandidateId + ", candidate=" + candidate
				+ ", joiningStatus=" + joiningStatus + ", expectedJoiningDate=" + expectedJoiningDate + ", comments="
				+ comments + ", offerLetterSentStatus=" + offerLetterSentStatus + ", offerLetterSentOn="
				+ offerLetterSentOn + ", selectedCandidateStatus=" + selectedCandidateStatus + ", createdOn="
